...
import UserSearch from '../components/Index/UserSearch/UserSearch';
...
export default function Index(): React.ReactElement {
  ...
  const handlePassPageClick = useCallback(
    (targetPage: number): void => {
  ...
  const handlePassApplicantsClick = () => {
    history.push('/pass-applicants');
  };
    ...
    <div className={classes.app}>
      ...
      <div className={classes.appWrap}>
        ...
        <div className={classes.right}>
          ...
          {totalPassUsers.length === 12 && (
            <button type='button' onClick={handlePassApplicantsClick}>
              Pass Applicants
            </button>
          )}
        </div>
